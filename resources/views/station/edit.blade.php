    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{ route('station.update', $data->id) }}">
                            {{ csrf_field() }}
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" id="line_id" name="line_id">
                                        ...
                                        @foreach($lines as $line)
                                            <option value="{{$line->id}}" {{$line->id == $data->line->id ? 'selected' : ''}}>{{$line->title}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group{{ $errors->has('critical') ? ' has-error' : '' }}">
                                <div class="form-check">
                                    ...
                                    <div class="col-md-6">
                                        <input class="form-check-input" {{$data->critical == 1 ? "checked" : ""}} type="checkbox" id="critical" name="critical">
                                    </div>
                                </div>
                            ...
                            <div class="form-group{{ $errors->has('test') ? ' has-error' : '' }}">
                                <div class="form-check">
                                    ...
                                    <div class="col-md-6">
                                        <input class="checkbox" type="checkbox" {{$data->test == 1 ? "checked" : ""}} id="test" name="test">
                                    </div>
                                </div>
                                @if ($errors->has('test'))
                                    <span class="help-block">
